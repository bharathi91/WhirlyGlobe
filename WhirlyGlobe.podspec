Pod::Spec.new do |s|
  ...
  s.subspec 'Headers' do |headers|
    ...
    headers.dependency 'eigen/Eigen'
    headers.dependency 'boost/boost/shared_ptr-includes'
    headers.dependency 'boost/boost/pointer_cast-includes'
    headers.dependency 'boost/boost/math-includes'
  end
